  ...
  return {
    ...
    content: [
      ...
      // ═══ ПРЕАМБУЛА ═══
      {
        ...
        fontSize: 9, lineHeight: 1.5, color: G1, margin: [0, 0, 0, 12],
      },
      ...
      // ═══ ТАБЛИЦЯ ═══
      {
        table: {
          ...
          body: [
            (vatPayer
              ? ['№', 'Найменування послуги', 'Од.', 'К-сть', 'Ціна без ПДВ', 'ПДВ', 'Сума ПДВ', 'Сума']
              : ['№', 'Найменування послуги', 'Од.', 'К-сть', 'Ціна', 'Сума']
            ).map(t => ({
      ...
      { text: '', margin: [0, 8] },
      {
        ...
        fontSize: 9, lineHeight: 1.4, color: G1,
      },
        ...
        columns: [
          {
            width: '48%',
            stack: [
              { text: 'ВИКОНАВЕЦЬ', fontSize: 6.5, letterSpacing: 2, color: G2, margin: [0, 0, 0, 12] },
          ...
          },
          {
            width: '48%',
            stack: [
              { text: 'ЗАМОВНИК', fontSize: 6.5, letterSpacing: 2, color: G2, margin: [0, 0, 0, 12] },
              { canvas: [{ type: 'line', x1: 0, y1: 0, x2: 200, y2: 0, lineWidth: 0.5, lineColor: G3 }] },
